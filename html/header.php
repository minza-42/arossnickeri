...
<header class="main-header">
  <div class="header-wrapper">
    ...
    <nav class="navigation" aria-label="Huvudnavigation">
      <ul>
        ...
        <li><a href="<?= $root ?>html/om-oss.php" <?= (isset($active_page) && $active_page === 'om-oss') ? ' class="active"' : '' ?>>Om oss</a></li>
        <li><a href="<?= $root ?>html/vad-vi-gor.php" <?= (isset($active_page) && $active_page === 'vad-vi-gor') ? ' class="active"' : '' ?>>Vad vi gör</a></li>
  ...
  <nav class="mobile-navigation" aria-label="Mobilnavigation" hidden>
    <ul>
      ...
      <li><a href="<?= $root ?>html/vad-vi-gor.php">Vad vi gör</a></li>
